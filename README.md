...
For a larger configuration covering themes, layouts, menus, actions, preferences, and ReaPack, see the [modular example flake](docs/example/README.md).
...
In addition to the SWELL palette bundled with Reapertips, the flake packages the community-made [ReaLinux dark and light palettes](https://stash.reaper.fm/theme/2802/ReaLinuxThemes.zip).
