...
in {
  ...
  config.programs.reaper.ini.contributions =
    reaperPreference.contributions [
      {
        path = "preferences.general.keyboardMultitouch.momentaryKeyboardSectionOverrideTimeoutMilliseconds";
        value = cfg.momentaryKeyboardSectionOverrideTimeoutMilliseconds;
        section = "reaper";
        key = "kbd_override_len";
        codec = "integer";
      }
      {
        path = "preferences.general.keyboardMultitouch.multitouch.swipe.gearing";
        value = cfg.multitouch.swipe.gearing;
        section = "reaper";
        key = "multitouch_swipe_gear";
        codec = "float";
      }
      {
        path = "preferences.general.keyboardMultitouch.multitouch.zoom.gearing";
        value = cfg.multitouch.zoom.gearing;
        section = "reaper";
        key = "multitouch_zoom_gear";
        codec = "float";
      }
      {
        path = "preferences.general.keyboardMultitouch.multitouch.rotate.gearing";
        value = cfg.multitouch.rotate.gearing;
        section = "reaper";
        key = "multitouch_rotate_gear";
        codec = "float";
      }
      {
        path = "preferences.general.keyboardMultitouch.multitouch.ignoreNewGestureAfterGestureMilliseconds";
        value = cfg.multitouch.ignoreNewGestureAfterGestureMilliseconds;
        section = "reaper";
        key = "multitouch_ignore_ms";
        codec = "integer";
      }
      {
        path = "preferences.general.keyboardMultitouch.multitouch.ignoreScrollAfterGestureMilliseconds";
        value = cfg.multitouch.ignoreScrollAfterGestureMilliseconds;
        section = "reaper";
